  ...
  return (
    <header className="relative bg-green-600 bg-opacity-90 shadow-lg">
      ...
      <div className="relative z-10 container mx-auto px-4 py-4">
        ...
        {/* News Ticker */}
        {latestNews.length > 0 && (
          <div className="mt-3 bg-black bg-opacity-20 rounded-md p-2">
            <div className="flex items-center space-x-1 mb-1">
              ...
              <span className="text-white text-xs font-normal">Latest News</span>
            </div>
            <div className="space-y-1">
              {latestNews.map((news) => (
                <div key={news.id} className="text-white text-xs leading-tight">
                  <Link
                    to={`/news/${news.id}`}
