 ...
 */
export function calculateReferralBonus(referralCount = 0) {
 ...
 */
export function calculateStakesInterest(stakes = []) {
 ...
 */
export function calculateTotalStakes(stakes = []) {
  return (Array.isArray(stakes) ? stakes : [])
    .filter(stake => stake && stake.status === 'active')
 ...
 */
export function calculateTotalWithdrawals(transactions = []) {
  return (Array.isArray(transactions) ? transactions : [])
 ...
 */
export function calculateAdminMetrics(users = [], transactions = [], stakes = []) {
 ...
 */
export function filterTransactions(transactions = [], typeFilter = 'all', statusFilter = 'all') {
 ...
 */
export function calculateMaturityDate(startDate, stakePeriod) {
 ...
 */
export function isStakeMatured(stake) {
 ...
 */
export function calculateStakeInterest(stake) {
 ...
 * Get user statistics
 */
export function getUserStats(user, transactions = [], stakes = []) {
  const transactionsArray = Array.isArray(transactions) ? transactions : [];
